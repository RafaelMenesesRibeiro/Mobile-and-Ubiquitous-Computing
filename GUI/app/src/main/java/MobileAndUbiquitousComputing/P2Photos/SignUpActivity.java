...
public class SignUpActivity extends AppCompatActivity {
    ...
    public void SignUpClicked(View view) {
        ...
        try {
            ...
            Toast toast = Toast.makeText(this, "The username '" + username + "' already exists",
                    Toast.LENGTH_LONG);
            toast.show();
        } catch (UsernameException uex) {
            Toast toast = Toast.makeText(this, "The username '" + username + "' does not follow " +
                    "the rules", Toast.LENGTH_LONG);
            toast.show();
        } catch (PasswordException pex) {
            Toast toast = Toast.makeText(this, "The password '" + password + "' does not follow " +
                    "the rules", Toast.LENGTH_LONG);
            toast.show();
        } catch (FailedOperationException foex) {
            Toast toast = Toast.makeText(this, "The Sign Up operation failed. Try again later",
                    Toast.LENGTH_LONG);
            toast.show();
    ...
    private void signup(String username, String password)
        ...
        try {
            ...
            RequestData requestData = new PostRequestData(this, RequestData.RequestType.SIGNUP,
                    url, requestBody);
            ...
            if (code == HttpURLConnection.HTTP_OK) {
                ...
                Log.i("STATUS", "The sign up operation was unsuccessful. The username chosen " +
                        "already exists.");
                throw new UsernameExistsException();
            } else {
                Log.i("STATUS",
                        "The sign up operation was unsuccessful. Server response code: " + code);
